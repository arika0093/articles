...
emoji: "🚀"
type: "tech"
topics: ["github-copilot", "opencode", "llm"]
published: true
---

:::message
この記事は[ブログ](https://eclairs.cc/posts/2026/20260524/use-opencode-go-in-github-copilot)でも公開しています。
:::
...
[このリンク](https://opencode.ai/go?ref=5TRCSNFQ0X)から~~登録する~~契約すると$5(初回1ヶ月分)のクレジットがもらえるので、アフィが気にならない人はここからどうぞ。

> 26/05/25追記: 登録するだけではだめで、サブスクを契約する必要がある様子。
